...
import tech.yongcheng.yongan.sdk.v3.codec.abi.Constant;
import tech.yongcheng.yongan.sdk.v3.codec.datatypes.AbiTypes;
...
import tech.yongcheng.yongan.sdk.v3.codec.scale.FunctionEncoder;
import tech.yongcheng.yongan.sdk.v3.codec.scale.FunctionReturnDecoder;
...
import tech.yongcheng.yongan.sdk.v3.codec.wrapper.ContractCodecJsonWrapper;
...
import tech.yongcheng.yongan.sdk.v3.model.EventLog;
    ...
    public ContractCodec(CryptoSuite cryptoSuite, boolean isWasm) {
        ...
        if (isWasm) {
            ...
            this.functionEncoder =
                    new tech.yongcheng.yongan.sdk.v3.codec.abi.FunctionEncoder(cryptoSuite);
            this.functionReturnDecoder =
                    new tech.yongcheng.yongan.sdk.v3.codec.abi.FunctionReturnDecoder();
        }
    ...
    public byte[] encodeConstructorFromString(String abi, String bin, List<String> params)
        ...
        try {
            ...
            if (isWasm) {
                ...
                paramBytes =
                        tech.yongcheng.yongan.sdk.v3.codec.abi.FunctionEncoder.encodeConstructor(
                                types);
            }
            ...
            if (abiDefinition.getInputs().size() == params.size()) {
                ...
                try {
                    ...
                    if (this.isWasm) {
                        ...
                        outputStream.write(
                                tech.yongcheng.yongan.sdk.v3.codec.abi.FunctionEncoder
                                        .encodeParameters(inputTypes, methodID));
                    }
                    return outputStream.toByteArray();
                } catch (IOException e) {
    ...
    public byte[] encodeMethodByIdFromString(String abi, byte[] methodId, List<String> params)
        ...
        try {
            ...
            if (this.isWasm) {
                ...
                outputStream.write(
                        tech.yongcheng.yongan.sdk.v3.codec.abi.FunctionEncoder.encodeParameters(
                                inputTypes, methodID));
            }
            return outputStream.toByteArray();
        } catch (IOException e) {
