 ...
 */
public abstract class TypeReference<T extends tech.yongcheng.yongan.sdk.v3.codec.datatypes.Type>
    ...
    public static <T extends tech.yongcheng.yongan.sdk.v3.codec.datatypes.Type>
            TypeReference<T> create(Class<T> cls, boolean indexed) {
    ...
    public static <T extends tech.yongcheng.yongan.sdk.v3.codec.datatypes.Type>
            TypeReference<T> create(Type type) {
     ...
     * @return actual class inheritance {@link tech.yongcheng.yongan.sdk.v3.codec.datatypes.Type}
     * @throws ClassNotFoundException throw when can not find any class match the param type
     */
    protected static Class<? extends tech.yongcheng.yongan.sdk.v3.codec.datatypes.Type>
            getAtomicTypeClass(String type) throws ClassNotFoundException {
    ...
    public static TypeReference makeTypeReference(String type, final boolean indexed)
        ...
        if (!nextSquareBrackets.find()) {
            final Class<? extends tech.yongcheng.yongan.sdk.v3.codec.datatypes.Type> typeClass =
        ...
        final Class<? extends tech.yongcheng.yongan.sdk.v3.codec.datatypes.Type> baseClass =
