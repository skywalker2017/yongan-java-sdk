 ...
 *
 */
package tech.yongcheng.yongan.sdk.v3.contract.precompiled.crud;
...
import tech.yongcheng.yongan.sdk.v3.contract.precompiled.crud.common.Common;
...
public class TableCRUDService {
    ...
    private String getTableName(String tableName) {
        if (tableName.length() > Common.TABLE_PREFIX.length()
                && tableName.startsWith(Common.TABLE_PREFIX)) {
            return tableName;
        }
        return Common.TABLE_PREFIX
