 ...
 */
package tech.yongcheng.yongan.sdk.v3;

import org.slf4j.Logger;
import org.slf4j.LoggerFactory;
import tech.yongcheng.yongan.sdk.v3.amop.Amop;
...
import tech.yongcheng.yongan.sdk.v3.eventsub.EventSubscribe;
...
public class BcosSDK {
    ...
    public Client getClient(String groupId) throws BcosSDKException {
        try {
            return Client.build(groupId, config, 0L);
        } catch (Exception e) {
    ...
    public Client getClient() throws BcosSDKException {
        try {
            ...
            return Client.build(config.getNetworkConfig().getDefaultGroup(), config, 0L);
        } catch (Exception e) {
            logger.warn("create client for failed, error: ", e);
            throw new BcosSDKException("get Client failed, e: " + e.getMessage(), e);
        }
