...
import tech.yongcheng.yongan.sdk.v3.client.exceptions.ClientException;
import tech.yongcheng.yongan.sdk.v3.client.protocol.model.GroupNodeIniConfig;
import tech.yongcheng.yongan.sdk.v3.client.protocol.model.GroupNodeIniInfo;
import tech.yongcheng.yongan.sdk.v3.client.protocol.request.JsonRpcMethods;
import tech.yongcheng.yongan.sdk.v3.client.protocol.request.JsonRpcRequest;
import tech.yongcheng.yongan.sdk.v3.client.protocol.request.Transaction;
import tech.yongcheng.yongan.sdk.v3.client.protocol.response.*;
...
import tech.yongcheng.yongan.sdk.v3.model.callback.ResponseCallback;
...
public class ClientImpl implements Client {
    ...
    protected void initGroupInfo() {
        ...
        /*configOption.getCryptoMaterialConfig().getUseSmCrypto();*/
    ...
    public void sendTransactionAsync(
        ...
        this.callRemoteMethod(
                ...
                node,
                new JsonRpcRequest<>(
                        JsonRpcMethods.SEND_TRANSACTION_ASYNC,
                        Arrays.asList(/*this.groupID, node, */ signedTransactionData, withProof)),
                BooleanResp.class);
    }
    ...
    public BcosBlock getBlockByNumber(
        ...
        return this.callRemoteMethod(
                ...
                new JsonRpcRequest<>(
                        ...
                        Arrays.asList(
                                /*this.groupID, node, */ blockNumber, onlyHeader, onlyTxHash)),
                BcosBlock.class);
    }
    ...
    public BigInteger getBlockLimit() {
        ...
        BigInteger.valueOf(
                50L) */
        /*BigInteger.valueOf(this.rpcJniObj.getBlockLimit(this.groupID))*/
        /*;
        ...
        BigInteger blockLimit =
                getBlockNumber().getBlockNumber().add(BigInteger.valueOf(BLOCK_LIMIT_RANGE));
    ...
    public BcosGroupInfo getGroupInfo() {
        return this.callRemoteMethod(
                "",
                "",
                new JsonRpcRequest<>(JsonRpcMethods.GET_GROUP_INFO, Collections.emptyList()),
                BcosGroupInfo.class);
        /*try {
        ...
        try {
            ...
            Response response =
                    HttpUtils.httpRequest(
                            this.getConfigOption().getJniConfig().getPeers().get(0),
                            data,
                            this.configOption.getCryptoMaterialConfig().getAuth(),
                            this.configOption.getNetworkConfig().getTimeout());
            if (response == null) {
                throw new ClientException(
                        "callRemoteMethod failed for get response, result is empty");
            }
