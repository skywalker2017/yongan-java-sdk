package tech.yongcheng.yongan.sdk.v3.test.codec.scale;
...
import tech.yongcheng.yongan.sdk.v3.codec.scale.TypeDecoder;
import tech.yongcheng.yongan.sdk.v3.codec.scale.TypeEncoder;
import tech.yongcheng.yongan.sdk.v3.test.codec.TestFixture;
import tech.yongcheng.yongan.sdk.v3.utils.Hex;
import tech.yongcheng.yongan.sdk.v3.utils.Numeric;
...
public class TypeEncoderTest {
    ...
    public void testBool() throws IOException, ClassNotFoundException {
        ...
        Assert.assertEquals(TypeDecoder.decode("01", TypeReference.create(Bool.class)), new Bool(true));
    }
    ...
    public void testStaticBytes() throws IOException, ClassNotFoundException {
        ...
        assertEquals(
                ...
                ("000102030405"));
        Assert.assertEquals(TypeDecoder.decode("000102030405", TypeReference.create(Bytes6.class)), staticBytes);

        Bytes empty = new Bytes1(new byte[]{0});
        assertEquals(
                TestUtils.bytesToString(TypeEncoder.encode(empty)),
                ("00"));
        Assert.assertEquals(TypeDecoder.decode("00", TypeReference.create(Bytes1.class)), empty);
        ...
        Assert.assertEquals(TypeDecoder.decode( "7f", TypeReference.create(Bytes1.class)), ones);
        ...
        Assert.assertEquals(TypeDecoder.decode( "64617665", TypeReference.create(Bytes4.class)), dave);
    }
    ...
    public void testDynamicBytes() throws IOException, ClassNotFoundException {
        ...
        assertEquals(
                ...
                ("18" + "000102030405"));
        Assert.assertEquals(TypeDecoder.decode("18" + "000102030405", TypeReference.create(DynamicBytes.class)), dynamicBytes);

        DynamicBytes empty = new DynamicBytes(new byte[]{0});
        assertEquals(
                TestUtils.bytesToString(TypeEncoder.encode(empty)),
                ("04" + "00"));
        Assert.assertEquals(TypeDecoder.decode("04" + "00", TypeReference.create(DynamicBytes.class)), empty);
        ...
        Assert.assertEquals(TypeDecoder.decode("10" + "64617665", TypeReference.create(DynamicBytes.class)), dave);
        ...
        Assert.assertEquals(TypeDecoder.decode(expectHex, TypeReference.create(DynamicBytes.class)), loremIpsum);
    }
    ...
    public void testUtf8String() throws IOException, ClassNotFoundException {
        ...
        Assert.assertEquals(TypeDecoder.decode("34" + "48656c6c6f2c20776f726c6421", TypeReference.create(Utf8String.class)), string);
    }
